...
from proton_google_search import google_search, get_current_datetime
from proton_get_whether import get_weather
from proton_window_CTRL import open_app, close_app, folder_file
from proton_file_opner import Play_file
